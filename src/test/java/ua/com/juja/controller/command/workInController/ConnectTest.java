...
public class ConnectTest {
    ...
    public void testDoWork(){
        ...
        Mockito.verify(view).write("База успешно подключена");
    }
    ...
    public void testDoWorkWithFalseDBName(){
        ...
        Mockito.verify(view).write("Вы ввели: \n" +
    ...
    public void testDoWorkWithNotEnoughParams() {
        ...
        Mockito.verify(view).write("Недостаточно данных для запуска команды. Попробуйте еще раз");
    }
